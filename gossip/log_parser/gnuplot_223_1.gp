...
plot "rm_f2_h1.txt.plotdata" u ($1):(100*$3) with lines linestyle 1 title "F=2 HTL=1",\
"rm_f2_h3.txt.plotdata" u ($1):(100*$3) with lines linestyle 2 title "F=2 HTL=3",\
"rm_f2_h5.txt.plotdata" u ($1):(100*$3) with lines linestyle 3 title "F=2 HTL=5",\
"rm_f2_h7.txt.plotdata" u ($1):(100*$3) with lines linestyle 4 title "F=2 HTL=7"

...
plot\
"pss_h0_s0.txt.rev.indegrees.plotdata" u ($1):($3*2.5) with lines linestyle 1 title "H=0 S=0, tail strategy",\
"pss_h0_s0_rand.txt.rev.indegrees.plotdata" u ($1):($3*2.5) with lines linestyle 2 title "H=0 S=0, rand strategy",\

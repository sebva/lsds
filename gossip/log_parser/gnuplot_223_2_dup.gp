...
set output "../report/223_2_dup.pdf"
...
plot "rm_f1_h3.txt.dup.plotdata" u ($1):($2) with lines linestyle 1 title "F=1 HTL=3",\
"rm_f2_h3.txt.dup.plotdata" u ($1):($2) with lines linestyle 2 title "F=2 HTL=3",\
"rm_f3_h3.txt.dup.plotdata" u ($1):($2) with lines linestyle 3 title "F=3 HTL=3",\
"rm_f4_h3.txt.dup.plotdata" u ($1):($2) with lines linestyle 4 title "F=4 HTL=3",\

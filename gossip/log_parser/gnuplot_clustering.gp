...
plot\
"pss_h0_s0.txt.rev.clustering.plotdata" u ($1):($2*2.5) with lines linestyle 1 title "H=0 S=0",\
"pss_h0_s0_rand.txt.rev.clustering.plotdata" u ($1):($2*2.5) with lines linestyle 2 title "H=0 S=0, with rand select",\
